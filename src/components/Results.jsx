...
const RESULTS = {
  ...
  aiml: {
    selected: [
      ...
      { team: "INNOVISION", college: "AMC Engineering College" },
      { team: "WAKANDA'S VISION", college: "CMR Institute of Technology" },
      { team: "VISIONAUTS", college: "AMC Engineering College" },
      { team: "RRCE auralyx", college: "Rajarajeswari College of Engineering" },
      { team: "Chokepoint", college: "AMC Engineering College" },
    ],
  },
  cybersecurity: {
    selected: [
  ...
  "open-innovation": {
    selected: [
      ...
      { team: "Solace", college: "Christ University" },
    ],
  },
};
          ...
          <div className="reg-card border border-violet-300/30 bg-violet-300/5">
            ...
            <ul className="space-y-3 font-general text-sm text-blue-50/80">
              ...
              <li className="flex items-start gap-2">
                <span className="text-violet-300 mt-0.5">•</span>
                <span>
                  The hackathon will be held on <span className="text-violet-300 font-bold">April 9th</span>. All selected teams must attend.
                </span>
              </li>
            </ul>
          </div>
